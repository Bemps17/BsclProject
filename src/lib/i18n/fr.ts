...
export const fr: Translations = {
  ...
  teams: {
    ...
    emptyRecruiting: "Aucune équipe ne recrute pour le moment.",
    members: "membres",
    captain: "Capitaine",
    tagLabel: "Tag",
  ...
  login: {
    ...
    demoEnterFailed: "Impossible de démarrer le mode démo",
    demoExitFailed: "Impossible de quitter le mode démo",
    discordSim: {
      title: "Discord",
